...
## Table of Contents
- [Preface](https://zspec.jaredreisinger.com/00-preface)
- [Overview of Z-machine architecture](https://zspec.jaredreisinger.com/00-architecture)
- [1. Memory Map](https://zspec.jaredreisinger.com/01-memory-map)
...
- [9. Sound effects](https://zspec.jaredreisinger.com/09-sounds)
...
- [Appendix A. Error messages and debugging](https://zspec.jaredreisinger.com/appendix-a)
- [Appendix B. Conventional contents of the header](https://zspec.jaredreisinger.com/appendix-b)
- [Appendix C. Resources available](https://zspec.jaredreisinger.com/appendix-c)
- [Appendix D. A short history of the Z-machine](https://zspec.jaredreisinger.com/appendix-d)
- [Appendix E. Statistics](https://zspec.jaredreisinger.com/appendix-e)
- [Appendix F. Canonical Story Files](https://zspec.jaredreisinger.com/appendix-f)
...
Refer to [2. Numbers and arithmetic](https://zspec.jaredreisinger.com/02-numbers) for details.
- **Integers**: 16-bit signed (2's complement, range -32768 to 32767).
- **Arithmetic**: Must handle 16-bit signed overflow/underflow correctly.

## 3. Z-Strings and Characters
...
## 5. Routines
Refer to [5. How routines are encoded](https://zspec.jaredreisinger.com/05-routines) for details.
- Routines start with 1 byte indicating the number of locals (up to 15).
- In V1-V3, this is followed by that many 16-bit default values for locals.
- In V4+, default values are not present; locals are initialized to 0.
...
Refer to [7. Output streams and file handling](https://zspec.jaredreisinger.com/07-output) for details.
- Stream 1: Screen (normal text).
- Stream 2: Script (transcript).
- Stream 3: Memory (table of characters).
- Stream 4: Player's commands (file).

## 8. The Screen Model

Refer to [8. The screen model](https://zspec.jaredreisinger.com/08-screen) for details.

- V3: Status line and lower window.

- V4+: Windowing system (Windows 0 and 1).



## 9. Sound Effects

Refer to [9. Sound effects](https://zspec.jaredreisinger.com/09-sounds) for details.

- `sound_effect` (VAR:245) opcode.

- Supports bleeps (1=high, 2=low) or sampled sound (V5+).
...
Refer to [14. Complete table of opcodes](https://zspec.jaredreisinger.com/14-opcode-table) and [15. Dictionary of opcodes](https://zspec.jaredreisinger.com/15-opcodes) for full details.
...
- Lists standard error conditions (e.g., stack overflow, illegal opcode).



### [Appendix B. Conventional contents of the header](https://zspec.jaredreisinger.com/appendix-b)

- Details bitflags in Header Flags 1 and 2.
